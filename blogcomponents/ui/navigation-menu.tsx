...
const navigationMenuTriggerStyle = cva("nav-menu-link")
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown className="nav-menu-chevron" aria-hidden="true" />
  </NavigationMenuPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  <div className={cn("nav-menu-viewport-container")}> 
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="nav-menu-indicator__arrow" />
  </NavigationMenuPrimitive.Indicator>
))
